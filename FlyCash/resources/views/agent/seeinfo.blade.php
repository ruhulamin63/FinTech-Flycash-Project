@extends('layouts.app', ['page' => __('User Profile'), 'pageSlug' => 'ageninfo'])
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h2 class="title">{{ __('Agent Profile') }}</h2>
                </div>
                    <div class="card-body">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <label><h2>{{ __('Rahaman') }}</h2></label>
                            </div>

                            <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                <label><h3>{{ __('Email address => ') }}</h3></label>
                                <label><h2>{{ __('abc@gmail.com') }}</h2></label>
                            </div>
